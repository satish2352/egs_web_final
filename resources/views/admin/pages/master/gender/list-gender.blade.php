...
@section('content')
    ...
    <div class="main-panel">
                                            ...
                                            <tbody>
                                                @foreach ($gender_data as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ strip_tags($item->gender_name) }}</td>
        ...
        <form method="POST" action="{{ url('/delete-gender') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-gender') }}" id="showform">
            @csrf
            <input type="hidden" name="show_id" id="show_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-one-gender') }}" id="activeform">
            @csrf

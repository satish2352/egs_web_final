        ...
        <div class="content-wrapper mt-6">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Update User Type
                        </li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('update-usertype') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-2" name="usertype_name" id="usertype_name"
                                                placeholder="Enter the Title"
                                                value="@if (old('usertype_name')) {{ old('usertype_name') }}@else{{ $usertype_data->usertype_name }} @endif">
                                    ...
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-2" name="marathi_title" id="marathi_title"
                                                ...
                                                value="@if (old('marathi_title')) {{ old('marathi_title') }}@else{{ $usertype_data->marathi_title }} @endif">
                                ...
                                <input type="hidden" name="id" id="id" class="form-control"
                                    value="{{ $usertype_data->id }}" placeholder="">
                            </form>
                        </div>
                    </div>
                </div>

...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::get('/add-project-wise-users', ['as' => 'add-project-wise-users', 'uses' => 'App\Http\Controllers\Admin\ProjectUser\ProjectController@addProjectusers']);
    Route::post('/add-project-wise-users', ['as' => 'add-project-wise-users', 'uses' => 'App\Http\Controllers\Admin\Project\ProjectController@store']);
